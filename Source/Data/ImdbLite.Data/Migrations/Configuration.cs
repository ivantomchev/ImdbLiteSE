namespace ImdbLite.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ApplicationDbContext>
    {
        ...
        static void PopulateGenres(ApplicationDbContext context)
        {
            var genres = new List<Genre>()
            {
                ...
                new Genre{Type = "Family"},
                new Genre{Type = "Fantasy"},
                new Genre{Type = "FilmNoir"},
                new Genre{Type = "Horror"},
                new Genre{Type = "History"},
                new Genre{Type = "Music"},
                new Genre {Type = "Musical"},
                new Genre{Type = "Mystery"},
                new Genre{Type = "Romance"},
                new Genre{Type = "SciFi"},
                new Genre{Type = "Short"},
                new Genre{Type = "Sport"},
                new Genre{Type = "Thriller"},
                new Genre{Type = "War"},
                new Genre{Type = "Western"},
